<!-- siteContents\backOffice\properties\webForm\PropertyForm01.jsp -->
...
<div class="grid-15 mobile-grid-20" align="left">
    ...
    ><dalie:LocalizedString key="common.language.DE.short"/></option>  
    <option value="EN"
    	<c:if test="${WebForm.property.countryId == 'EN'}">
   			selected="selected"
		</c:if>
    ><dalie:LocalizedString key="common.language.EN.short"/></option>  
    <option value="FR"
    	<c:if test="${WebForm.property.countryId == 'FR'}">
   			selected="selected"
		</c:if>
    ><dalie:LocalizedString key="common.language.FR.short"/></option>  
       <option value="IT"
    	<c:if test="${WebForm.property.countryId == 'IT'}">
   			selected="selected"
		</c:if>
    ><dalie:LocalizedString key="common.language.IT.short"/></option> 
  </select>
