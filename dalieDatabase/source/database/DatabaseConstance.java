...
public interface DatabaseConstance {
	...
	public static final int initialSize = 100;    // The initial number of connections that are created when the pool is started. Since: 1.2
	public static final int maxActive = 150;      // The maximum number of active connections that can be allocated from this pool at the same time, or negative for no limit.
	public static final int maxIdle = 100;        // The maximum number of connections that can remain idle in the pool, without extra ones being released, or negative for no limit.
	public static final int minIdle = 30;        // The minimum number of connections that can remain idle in the pool, without extra ones being created, or zero to create none.
	...
	public static final String  connectionInitSqls = "";   
