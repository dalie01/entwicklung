...
import dalie.imme.design.sf.internal.product.ProductImpl;
...
public class ProductParser extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String name)
        ...
        } else if (name.equals(TAG_CATALOG)) {
            product.setCatalog(getCharactersTrimed());
        } else if (name.equals(TAG_CATEGORY)) {
            product.setCategory(getCharactersTrimed());     
