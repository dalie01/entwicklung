...
<%@page import="autoData.autoData,autoData.GetAutoData"%>
<html>
<head>
...
YAHOO.example.Data = {
		...
		menu: {
		 breakfasts: [
		 	<%= GetAutoData.writeDokumentHeaderToPageContext(autoData.valueOf("1")) %>
		 ],
		 lunches: [
			<%= GetAutoData.writeDokumentHeaderToPageContext(autoData.valueOf("2")) %>
		 ],
		 dinners: [
			<%= GetAutoData.writeDokumentHeaderToPageContext(autoData.valueOf("3")) %>
		 ]
		}
}; 
</script>
